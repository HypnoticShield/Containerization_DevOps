...
1. Installing  Vagrant and UTM plugin for mac
...
2. Initializing Vagrant with UTM specific Ubuntu box
...
3. Starting the VM and accessing it and installing Nginx
...
4. Checking the amount of space that the VM is taking in the hard disk and then destroying the VM
...
5. Running Ubuntu Docker container with Nginx

Using Docker *run* command and verify Nginx

![Container created](Exp1.6.png)

6. Checking space consumed by the Docker container

![Showing storage](Exp1.7.png)

7. Drawing a comparison
